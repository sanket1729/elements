...
from test_framework.messages import (COIN, CTransaction, CInv, CTxIn, COutPoint, CTxOut)
...
class ExampleTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        tx_hash = SegwitVersion1SignatureHash(script, tx, 0, SIGHASH_ALL, 50*COIN)
